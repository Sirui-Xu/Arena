...
class WaterWorldSnake(PyGameWrapper):
    """
    ...
    def game_over(self):
        ...
        """
        return (self.creep_counts['GOOD'] == 0) of self.player == None # or self.ticks > self.N_CREEPS * (self.width + self.height)
...
if __name__ == "__main__":
    ...
    pygame.init()
    game = WaterWorldSnake(width=512, height=512, num_creeps=10)
