...
project_root = os.path.dirname(dqn_root)
...
class DQGN_agent():
    ...
    def __init__(self, state_input_dim, state_output_dim, device, seed):
        ...
        # Q-Network
        #network_class=PrimDebugNetwork
        network_class=PrimQNetwork
        self.qnetwork_local = network_class(state_input_dim, state_output_dim).to(device)
        self.qnetwork_target = network_class(state_input_dim, state_output_dim).to(device)
