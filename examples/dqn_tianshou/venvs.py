...
class GraphBaseVectorEnv(gym.Env):
    ...
    def step(
        ...
        return obs_list, rew_stack, done_stack, info_stack
...
class GraphDummyVectorEnv(GraphBaseVectorEnv):
...
class GraphSubprocVectorEnv(GraphBaseVectorEnv):
