...
y_heuristic = [1.,3.,5.,6.97,8.96,10.29,12.5,14.28,15.81,17.31]
y_IL_heuristic = [1.0, 3.0, 4.99, 6.83, 8.53, 9.46, 10.89, 12.3, 13.69, 13.64]
...
y_ppo_mean = [ 1.,3.,5.,7.,9.,10.71666667,11.33666667,13.31,13.82,13.39333333]
y_ppo_std = [0.,0.,0.,0.,0.,0.23697163,0.08178563,0.25350871,0.0244949,0.27475241]
...
plt.plot(x, y_ppo_mean, label='PPO')
plt.plot(x, y_IL_heuristic, label='IL heuristic')
plt.plot(x, y_refactor_purify_6of10_max, label='IL DQN')
