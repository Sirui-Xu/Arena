...
from examples.rl_dqgnn.nn_utils import GraphObservationEnvWrapper, PointConv
from examples.env_setting_kwargs import get_env_kwargs_dict
from examples.deep_rl import *


# DQN
def graph_dqn_feature(**kwargs):
    generate_tag(kwargs)
    ...
    config.network_fn = lambda : PointConv(input_dim=8, pos_dim=4)
    ...
    config.state_normalizer = GraphDummyNormalizer
...
if __name__ == '__main__':
    ...
    game = 'CartPole-v0'
    #env_kwargs=get_env_kwargs_dict('AX0')
